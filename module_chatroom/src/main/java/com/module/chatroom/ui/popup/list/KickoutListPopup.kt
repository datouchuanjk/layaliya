...
internal fun KickoutListPopup(
   ...
   LaunchedEffect(Unit) {
    ...
    AppPopup(
        ...
        val pagingData = viewModel.kickoutList
        LaunchedEffect(pagingData) {
            ...
            AppPagingBox(
                ...
                LazyColumn(
                    ...
                    items(pagingData = pagingData, key = { it.uid }, emptyContent = {
                        EmptyItem()
                    }) {item ->
...
@Composable
private fun Top() {
    val list = stringArrayResource(R.array.room_silence_title)
    Row(
        modifier = Modifier
            .fillMaxWidth()
    ) {
    ...
    Row(
        ...
        Text(
            modifier = Modifier
                .weight(1f)
                .onClick{
                    viewModel.kickout(item.uid.toString(), item.yunxinAccid.toString())
                }
                .wrapContentWidth(),
            text = stringResource(R.string.room_out),
            fontSize = 10.sp,
